...
<section id="projects" class="mt-14 flex md:flex-col flex-col justify-center gap-8">
	...
	<p class="text-sm animate-fade animate-ease-in">
		...
		increíbles. Cada uno de ellos es una manifestación de mi pasión por la creación digital y mi
		compromiso con la excelencia técnica. Permíteme llevarte a un recorrido por algunos de mis
